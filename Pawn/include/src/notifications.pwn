...
#define TD_NOTIFICATION_LETTER_X 0.198535
#define TD_NOTIFICATION_LETTER_Y 1.150833
...
stock MinPosYNotification(playerid, TDN)
{
    if(TDN == 0)
    {
        TextDrawsNotification[playerid][TDN][MinPosY] = PI[playerid][pi_WANTED_LEVEL] == 0 ? 140.000000 : 163.0;
    }
    else
    {
        TextDrawsNotification[playerid][TDN][MinPosY] = TextDrawsNotification[playerid][TDN - 1][MaxPosY] + 5;
    }
    return 1;
}
...
stock CreateTDN(playerid, TDN)
{
    if(TextDrawsNotification[playerid][TDN][Use] == 1)
    {
		...
		TextDrawsNotification[playerid][TDN][TextDraw] = CreatePlayerTextDraw(playerid, 498.002593, TextDrawsNotification[playerid][TDN][MinPosY], TextDrawsNotification[playerid][TDN][Text]);
        ...
        PlayerTextDrawTextSize(playerid, TextDrawsNotification[playerid][TDN][TextDraw], floatadd(498.002593, 130.0), 1.000000);
        ...
        PlayerTextDrawBackgroundColor(playerid, TextDrawsNotification[playerid][TDN][TextDraw], 0x0000003C);
        PlayerTextDrawBoxColor(playerid, TextDrawsNotification[playerid][TDN][TextDraw], 0x0000003C);
