...
hook OnPlayerSpawn(playerid) {
       ...
       SendClientMessageEx(playerid, -1, "{8b00ff}•{FFFFFF}Los servicios {f11717}publicos {FFFFFF}fuero alertados, un {f11717}médico {FFFFFF}está en camino.");
       SendClientMessageEx(playerid, -1, "{8b00ff}•{FFFFFF}Estás {f11717}herido, {FFFFFF}puedes esperar 3 minutos y usar {8b00ff}/morir {FFFFFF}o esperar un {f11717}médico.");
       PLAYER_TEMP[playerid][pt_TIMERS][3] = SetTimerEx("TogglePlayerControl", 2000, false, "ib", playerid, true);
