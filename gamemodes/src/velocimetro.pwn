...
public OnPlayerCommandText(playerid,cmdtext[])
{
    ...
    SendClientMessage(playerid, -1,"{0080ff}[Velocimentro]: {FFFFFF}Vehiculo cerrado!");
    ...
    SendClientMessage(playerid, -1, "{0080ff}[Velocimentro]: {FFFFFF}Vehicle Abierto!");
    GetPlayerPos(playerid,X,Y,Z);
