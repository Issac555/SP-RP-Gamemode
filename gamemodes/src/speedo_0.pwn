...
static stock y_va_DoubleIndirection(dest[YSI_MAX_STRING], fmat[], var0, var1, var2, va_args<>) //var3, var4, size = sizeof (dest))
{
...
Test:y_va_BlankFormat2()
{
	new abc[32] = "WAT";
	YSI_g_sString[0] = '\0';
	y_va_BlankFormat2(abc);
	ASSERT(!strcmp(YSI_g_sString, "WAT"));
	YSI_g_sString[0] = '\0';
	y_va_BlankFormat2(abc);
	ASSERT(!strcmp(YSI_g_sString, "WAT"));
	YSI_g_sString[0] = '\0';
