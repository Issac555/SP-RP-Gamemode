...
SeedPlayerInventory(playerid) {
    ...
    if(PI[playerid][pi_BLACK] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Dinero Negro (%s)", number_format_thousand(PI[playerid][pi_BLACK]));
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1212;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 90.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_ZOOM] = 1.0;
        pInventoryItems[playerid][0][counter][pinv_TYPE] = INV_TYPE_BLACK;
        counter ++;
    }
    ...
    //Sistema de empacar
    if(PI[playerid][pi_MPACK50] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de marihuana (50g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1578;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_ZOOM] = 1.0;
        pInventoryItems[playerid][0][counter][pinv_TYPE] = INV_TYPE_PACKETS;
        pInventoryItems[playerid][0][counter][pinv_BUTTONS][0] = INV_BUTTON_TYPE_NONE;
        pInventoryItems[playerid][0][counter][pinv_BUTTONS][1] = INV_BUTTON_TYPE_GIVE;
        pInventoryItems[playerid][0][counter][pinv_BUTTONS][2] = INV_BUTTON_TYPE_SELL;
        pInventoryItems[playerid][0][counter][pinv_BUTTONS][3] = INV_BUTTON_TYPE_THROW;
        if(PI[playerid][pi_STATE] == ROLEPLAY_STATE_NORMAL || PI[playerid][pi_STATE] == ROLEPLAY_STATE_CRACK) {
    ...
    if(PI[playerid][pi_MPACK100] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de marihuana (100g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1578;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
    ...
    if(PI[playerid][pi_CPACK50] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de crack (50g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1580;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_ZOOM] = 1.0;
    ...
    if(PI[playerid][pi_CPACK100] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de crack (100g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1580;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
    ...
    if(PI[playerid][pi_DPACK50] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de medicina (50g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1579;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_ZOOM] = 1.0;
    ...
    if(PI[playerid][pi_DPACK100] && counter < MAX_INVENTORY_ITEMS) {
        pInventoryItems[playerid][0][counter][pinv_VALID] = true;
        format(pInventoryItems[playerid][0][counter][pinv_NAME], 64, "Paquete de medicina (100g)");
        pInventoryItems[playerid][0][counter][pinv_MODELID] = 1579;
        pInventoryItems[playerid][0][counter][pinv_MDL_RX] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RY] = 0.0;
        pInventoryItems[playerid][0][counter][pinv_MDL_RZ] = 0.0;
